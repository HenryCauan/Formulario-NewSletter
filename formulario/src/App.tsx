      ...
      <div className="container">
        {isLoading ? (
          <div className="subcontainer">
            <div className="hero">
              <h1>Stay updated!</h1>
              <p className='description'>Join 60,000+ product managers receiving monthly <br></br> updates on:</p>
              <ul>
                <li><i className="ri-check-line"></i>Product discovery and building what meatters</li>
                <li><i className="ri-check-line"></i>Measuring to ensure updates are a success</li>
                <li><i className="ri-check-line"></i>And much more!</li>
              </ul>
              <label>
                ...
                <input
                  ...
                  className={isEmailEmpty ? 'error' : ''}
                />
              </label>
              <button onClick={handleSubscribe}>Subscribe to monthly newsletter</button>
            </div>
            <svg 
          ...
          : (
            <div>
              <div className="message">
                ...
                <p>A confirmation email has been sent to <br></br> <span>ash@loremcompany.com</span>. Please open it and click <br></br> the button inside to confirm your subscription.</p>
                <button onClick={handleSubscribe}>Dismiss message</button>
              </div>
            </div>
          )}
      </div>
